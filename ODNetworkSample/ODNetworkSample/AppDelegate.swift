...
@UIApplicationMain
class AppDelegate: ODAppDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let URLCache = ODURLCache(memoryCapacity: 4 * 1024 * 1024, diskCapacity: 20 * 1024 * 1024, diskPath: nil)
        ODURLCache.setSharedURLCache(URLCache);
        
        self.window = UIWindow(frame: UIScreen.mainScreen().bounds) //aWindow
